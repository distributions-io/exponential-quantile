...
describe( 'distributions-exponential-quantile', function tests() {
	...
	it( 'should evaluate the quantle function of the Exponential distribution when provided a typed array', function test() {
